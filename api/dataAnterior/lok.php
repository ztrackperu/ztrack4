...
<?php
$er = $api->dataAnterior($variable,$Estructura);
...
//$temp1= $contenedor->temp_supply_1;
    ...
    if($contarResultado['count(*)'] == 0){
        ...
        $C = $api->updateContenedorR( $set_point, $temp_supply_1,$return_air,$evaporation_coil,$ambient_air,$cargo_1_temp,$cargo_2_temp,$cargo_3_temp,$cargo_4_temp,$relative_humidity , $alarm_present,$alarm_number,$controlling_mode,$power_state,$defrost_term_temp , $defrost_interval ,$latitud,$longitud, $ultima_fecha ,$empresaAsignada,$segundoFiltro);
