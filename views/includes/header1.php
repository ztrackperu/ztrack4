                    ...
                    <div id="collapseVenta" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            if (!empty($nueva_venta)) { ?>
                                <a class="collapse-item" href="?pagina=trama_genset">Genset</a>
                            <?php }
                            if (!empty($ventas)) { ?>
                                <a class="collapse-item" href="?pagina=trama_reffer">Reffer</a>
                            <?php } ?>
                            
                           <?php if (!empty($ventas)) { ?>
                                <a class="collapse-item" href="?pagina=trama_madurador">Madurador</a>
                            <?php } ?>
                        </div>
                    </div>
                </li>
