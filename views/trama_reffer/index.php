<form id="frmTramaReffer" autocomplete="off">
    <div class="card mb-2">
        <p></p>
        <H2 align ="center"> Contenedores tipo Reffer</H2>
    </div>
</form>
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover" style="width: 100%;" id="table_reffer">
                <thead>
                    <tr>
...
<div id="modalTramaReffer" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tramas de tipo Reefer</h5>
    ...
    <div class="card-body">
        <div class="table-responsive">
      <table class="table table-striped table-hover" style="width: 100%;" id="table_reffer1">
  <thead>
    <tr>
