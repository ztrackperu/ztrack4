...
<head>
    ...
    <link href="assets/vendor/fontawesome-free/css/all.min.js" rel="stylesheet" type="text/css">
    <link
...
<body class="bg-gradient-primary">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">-> Bienvenido a Ztrack <-</h1>
                                    </div>
    ...
    <script src="../assets/js/loginz1.js"></script>
</body>
